...
export function getsharedDocument(userData) {
  return (dispatch) => {
    ...
    const url = '/server/documents?role=' + userData.role._id;
...
export function addSharedDocs(offset, userRole) {
  return (dispatch) => {
    ...
    const url = '/server/documents?role=' + userRole + '&offset=' + offset;
    return apiRequest(null, 'get', url, function (apiResult) {
...
export function addOwnedDocs(offset, userId) {
  return (dispatch) => {
    dispatch(addingMoreDocToStore());
    const url = '/server/users/' + userId + '/documents/?offset=' + offset;
    return apiRequest(null, 'get', url, function (apiResult) {
...
export function deleteDocAction(docId) {
  return (dispatch) => {
    const url = '/server/documents/' + docId;
...
export function getUserDocs(userId) {
  return (dispatch) => {
    dispatch(gettingUserDocs());
    const url = '/server/users/' + userId + '/documents';
    return apiRequest(null, 'get', url, function (apiResult) {
...
export function validateUser() {
  return (dispatch) => {
    const url = '/server/users/getData';
    return apiRequest(null, 'get', url, function (apiResult) {
      if (apiResult.user) {
