        ...
        function() {
          ...
          it('Ensure that document can be pagination with limit and offset',
            function(done) {
              ...
              server
                .get('/server/documents/?limit=1&offset=2')
                .set({ token: token })
                .expect('Content-type', /json/)
                .end(function(err, res) {
                  res.status.should.equal(200);
      ...
      describe('Ensure that document can be searched', function() {
        ...
        it('Ensure that search result can be sort by document owner',
          function(done) {
            ...
            server
              .get('/server/documents/?q=this&sort=owner')
              .set({ token: token })
              .expect('Content-type', /json/)
              .end(function(err, res) {
                res.status.should.equal(200);
        ...
        it('Ensure that search result can be sort by date created',
          function(done) {
            ...
            server
              .get('/server/documents/?q=this&sort=createdAt')
              .set({ token: token })
              .expect('Content-type', /json/)
              .end(function(err, res) {
                res.status.should.equal(200);
        ...
        it('Ensure that search result can be sort by access type',
          function(done) {
            ...
            server
              .get('/server/documents/?q=this&sort=access')
              .set({ token: token })
              .expect('Content-type', /json/)
              .end(function(err, res) {
                res.status.should.equal(200);
        ...
        function() {
          ...
          it('Ensure that search result can be filtered by date created',
            function(done) {
              ...
              server
                .get('/server/documents/?q=this&date=' + today)
                .set({ token: token })
                .expect('Content-type', /json/)
                .end(function(err, res) {
                  res.status.should.equal(200);
          ...
          it('Ensure that search result can be filtered by date edited',
            function(done) {
              ...
              server
                .get('/server/documents/?q=this&edit=' + today)
                .set({ token: token })
                .expect('Content-type', /json/)
                .end(function(err, res) {
                  res.status.should.equal(200);
          ...
          it('Ensure that search result can be filtered by creator',
            function(done) {
              ...
              server
                .get('/server/documents/?q=this&owner=' + docs[0].creator._id)
                .set({ token: token })
                .expect('Content-type', /json/)
                .end(function(err, res) {
                  res.status.should.equal(200);
          ...
          it('Ensure that search result can be filtered by role',
            function(done) {
              ...
              server
                .get('/server/documents/?q=this&role=1')
                .set({ token: token })
                .expect('Content-type', /json/)
                .end(function(err, res) {
                  res.status.should.equal(200);
          ...
          it('Ensure that search result can be sorted by title',
            function(done) {
              ...
              server
                .get('/server/documents/?q=this&title=0990')
                .set({ token: token })
                .expect('Content-type', /json/)
                .end(function(err, res) {
                  res.status.should.equal(200);
